 ...
 * @LastEditors: 王利
 * @LastEditTime: 2020-12-07 14:49:36
 */
...
/**
 * @description: 设置localStorage本地存储
...
/**
 * @description: 获取localStorage本地存储
...
/**
 * @description: 移除localStorage本地存储
 * @param {*} key localStorage键
 * @return {*}  localStorage值
 */
...
/**
 * @description: 设置sessionStorage本地存储
 * @param {string} key sessionStorage键
...
/**
 * @description: 获取sessionStorage本地存储
 * @param {*} key sessionStorage键
 * @return {*}  sessionStorage值
 */
export const getSession = key => {
  return sessionStorage.getItem(key);
};
/**
 * @description: 移除sessionStorage本地存储
 * @param {*} key sessionStorage键
 * @return {*}  sessionStorage值
 */
