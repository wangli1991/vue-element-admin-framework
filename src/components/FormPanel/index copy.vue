 ...
 * @LastEditors: 王利
 * @LastEditTime: 2020-09-24 13:52:15
-->
<template>
  <div>
    <el-form ref="form" :model="formList" :label-width="labelWidth === 'auto' ? 'auto' : labelWidth + 'px'" :rules="rules" size="medium">
      <template v-for="(item, index) in list">
        <el-form-item :key="index" :label="item.label" :prop="item.fieldName">
      ...
      <el-form-item label="活动形式" prop="desc">
        <el-input v-model="formList.desc" type="textarea"></el-input>
      </el-form-item> -->
      <el-form-item>
